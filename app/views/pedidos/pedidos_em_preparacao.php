                ...
                <div class="card" style="margin-bottom: 20px;">
                    <div class="card-body">
                        ...
                        if (isset($_SESSION['funcionario'])) {
                            if (strcmp($_SESSION['funcionario']['cargo'], 'Funcionário Gerente') == 0 || strcmp($_SESSION['funcionario']['cargo'], 'Funcionário Cozinha') == 0) {
                            ...
                            if (strcmp($_SESSION['funcionario']['cargo'], 'Funcionário Cozinha') == 0) {
                                echo '<a href="finalizar_pedido.php?id=' . $pedido['id'] . '" class="btn btn-warning">Finalizar
                                Pedido</a>
                            </div>';
                            }
                        }
